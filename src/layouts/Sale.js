...
const stockInfo = [
    // sliders
    {
        ...
        text:"Экономь, познавая вкусы! Узнай свой вкус с нашими ознакомительными наборами по выгодной цене",
        deadline: "ꚙ"
    },
    {
        className: 'slide',
